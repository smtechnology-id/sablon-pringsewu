                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <a target="_blank" href="{{ asset('storage/' . $order->payment_proof) }}"
                                                class="btn btn-success">Download Payment Proof</a>
                                                    ...
                                                    <div class="modal-content">
                                                        <form action="{{ route('admin.order.update', $order->id) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                @csrf
                                                                <input type="hidden" name="code_order"
                                        ...
                                        @foreach ($productOrder as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($product->design)
                                                        <a target="_blank"
                                                            href="{{ asset('storage/' . $product->design) }}"
                                                            class="btn btn-success">Download Desain</a>
                                                    @else
